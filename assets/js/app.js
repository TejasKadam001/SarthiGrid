// ==========================================================================
// Translation Engine (Static Dictionary)
// ==========================================================================
const T = {
  mr: {
    ...
    nav_driver_reg: 'ड्रायव्हर नोंदणी',
    nav_portal_login: 'पोर्टल लॉगिन',
    btn_track_live: 'थेट मागोवा ↗',
    hero_title: 'पालखी प्रवासाचा थेट मागोवा घ्या.',
    hero_desc: 'पवित्र वारी प्रवासाशी जोडलेले राहा. थेट स्थान, मार्ग अद्यतने, अंदाजे आगमन वेळ आणि महत्त्वाच्या घोषणा पहा.',
    hero_status_dot: 'दोन्ही पालख्या वारीच्या प्रवासात मार्गस्थ आहेत. थेट मागोवा उपलब्ध आहे.',
    tukaram_palkhi: 'श्री संत तुकाराम महाराज पालखी',
    dnyaneshwar_palkhi: 'श्री संत ज्ञानेश्वर महाराज पालखी',
    current_stop: 'सध्याचा थांबा',
    last_updated: 'शेवटचे अद्यतन',
    tracking_closed: 'थेट मागोवा बंद',
    btn_about_us: 'माहिती ↗',
    live_tracking_badge: 'थेट मागोवा',
    map_title: 'वारकरी सुविधा शोधक नकाशा',
    tab_both: 'दोन्ही',
    tab_dnyaneshwar: 'श्री संत ज्ञानेश्वर महाराज',
    tab_tukaram: 'जगद्गुरू श्री संत तुकाराम महाराज',
    search_placeholder: 'ठिकाण, डॉक्टर, वाहन क्रमांक शोधा…',
    chip_100m: '१०० मी',
    chip_200m: '२०० मी',
    chip_300m: '३०० मी',
    chip_1km: '१ किमी',
    chip_5km: '५ किमी',
    chip_all: 'सर्व',
    mukkam_title: 'पालखी मुक्काम वेळापत्रक',
    emergency_dials_title: 'तातडीची मदत · Emergency Dials',
    dial_ambulance: 'रुग्णवाहिका',
    dial_emergency: 'आपत्कालीन',
    helpline_other: 'इतर आरोग्य हेल्पलाईन',
    helpline_advisory: 'आरोग्य सल्ला / तक्रार / रक्त उपलब्धता / मानसिक आरोग्य',
    helpline_jssy: 'जननी शिशु सुरक्षा कार्यक्रम',
    helpline_mjp: 'महात्मा ज्योतिबा फुले जन आरोग्य योजना',
    helpline_disaster: 'आपत्ती व्यवस्थापन',
    helpline_district: 'जिल्हानिहाय अधिकारी',
    helpline_state: 'राज्य / विभागीय / मनपा अधिकारी',
    helpline_police: 'पोलीस संपर्क',
    clips_title: 'आरोग्य संदेश · व्हिडिओ / ऑडिओ',
    clips_all: 'सर्व व्हिडिओ / ऑडिओ पहा',
    mapcard_title: 'मदत नकाशा',
    mapcard_subtitle: 'दोन्ही पालख्या',
    btn_1km_all: '१ किमी — सर्व मदत',
    btn_my_location: 'माझे स्थान',
    btn_back_to_route: 'मार्गावर परत',
    dest_label: "Today's Destination",
    dest_val: 'लोणी काळभोर व सासवड',
    eta_label: 'Estimated Arrival Time',
    eta_val: '५:४५ PM',
    sub_amb: 'रुग्णवाहिका प्रकार:',
    sub_doc: 'दवाखाना प्रकार:',
    sub_water: 'पाणी प्रकार:',
    sub_halt: 'थांबा प्रकार:',
    leg_all: 'सर्व',
    leg_ambulance: 'रुग्णवाहिका',
    leg_doc: 'डॉक्टर/दवाखाना',
    leg_water: 'पाणी',
    leg_toilet: 'शौचालये',
    leg_police: 'पोलीस',
    leg_charanseva: 'चरणसेवा',
    leg_hirkani: 'हिरकणी कक्ष',
    leg_halt: 'मुक्काम',
    leg_loc: 'माझे स्थान',
    stat_devotees: 'भाविक',
    stat_journey: 'किमी प्रवास',
    stat_updates: 'थेट अद्यतने',
    stat_halts: 'थांबे',
    impact_badge: 'प्रभाव',
    impact_title: 'पवित्र वारीच्या माध्यमातून कोट्यवधी भाविकांना जोडत आहे',
    impact_desc: 'थेट जीपीएस ट्रॅकिंग, मार्ग अद्यतने, थांबे आणि अंदाजे आगमन वेळेसह वारीचा अभूतपूर्व अनुभव घ्या. आमचा मंच भाविक, स्वयंसेवक आणि अभ्यागतांना माहिती पुरवतो.',
    impact_today_journey: 'आजचा प्रवास',
    impact_next_halt: 'पुढील थांबा वेळ',
    summary_badge: 'आढावा',
    summary_title: 'वारी व्यवस्था आणि नियोजनाचा आढावा',
    summary_desc: 'प्रशासनाने आषाढी वारी २०२६ साठी २४x७ स्मार्ट देखरेख, वारी नियोजन, सार्वजनिक सुरक्षा प्रणाली आणि मोठ्या प्रमाणावर ऑन-ग्राउंड नियोजन एकत्रित करून एक सुरक्षित आणि सुलभ वारी अनुभव सुनिश्चित केला आहे.',
    faq_badge: 'तथ्य',
    faq_title: 'वारी २०२६: सुविधा आणि नियोजन',
    faq_q1: 'हे पृष्ठ देहू आणि आळंदी ते पंढरपूर संपूर्ण प्रवासासाठी सक्रिय आहे का?',
    faq_a1: 'होय, हा मंच संपूर्ण प्रवासादरम्यान भाविकांना थेट स्थान आणि आजूबाजूच्या सुविधांची माहिती पुरवण्यासाठी सक्रिय राहतो.',
    faq_q2: 'वारी बंदोबस्तासाठी किती स्वयंसेवक आणि समन्वयक ऑन-ग्राउंड आहेत?',
    faq_a2: 'सुरक्षित प्रवासासाठी आणि गर्दीच्या नियोजनासाठी वारी मार्गावर हजारो सुरक्षा रक्षक, आरोग्य स्वयंसेवक आणि प्रशासकीय समन्वयक तैनात करण्यात आले आहेत.',
    faq_q3: 'थेट स्थान आणि आजूबाजूच्या सेवांचे अंतर कसे दर्शविले जाते?',
    faq_a3: 'पालखी रथासोबत असलेल्या प्रशासकीय वाहनांना लावलेल्या जीपीएस यंत्रणेद्वारे आणि ऑन-ग्राउंड स्वयंसेवकांच्या मदतीने थेट स्थान आणि अंतर दर्शविले जाते.',
    faq_metric_palkhis: 'पवित्र पालख्या',
    faq_metric_route: 'रोजचा प्रवास',
    faq_metric_coord: 'ऑन-ग्राउंड समन्वय',
    btn_route_map: 'मार्ग नकाशा ↗',
    footer_overlay_title: 'वारीच्या प्रवासात अद्ययावत राहा',
    footer_col_palkhi: 'पालखी',
    footer_col_emergency: 'आपत्कालीन संपर्क',
    footer_scroll_top: 'वर जा ↗',
    nav_portal_login: 'पोर्टल लॉगिन',
    nav_landing: 'मुख्य पान',
    
    // Dynamic labels
    dy_amb_service: 'रुग्णवाहिका सेवा',
    dy_hosp_service: 'रुग्णालय सेवा',
    dy_doc_service: 'डॉक्टर / आरोग्य सेवा',
    dy_water_service: 'पाणी',
    dy_help_center: 'मदत केंद्र',
    dy_veh_no: 'वाहन क्रमांक:',
    dy_service: 'सेवा:',
    dy_place: 'ठिकाण:',
    dy_base: 'मूळ ठिकाण:',
    dy_toilet: 'एकूण शौचालये:',
    dy_date: 'तारीख:',
    dy_phase: 'टप्पा:',
    dy_direction: 'दिशा',
    dy_share: 'शेअर',
    dy_nearby_help: 'या मुक्कामाजवळील सर्व मदत (१ किमी)',
    dy_you_are_here: 'आपण येथे आहात',
    dy_gps_not_active: 'GPS सुरू नाही',
    dy_gps_getting: 'GPS स्थान घेत आहोत…',
    dy_gps_denied: 'स्थान परवानगी नाकारली. सेटिंग्जमध्ये परवानगी द्या.',
    dy_gps_timeout: 'GPS वेळेत मिळाले नाही. पुन्हा प्रयत्न करा.',
    dy_gps_error: 'GPS मिळाले नाही. पुन्हा प्रयत्न करा.',
    dy_gps_acc: 'तुमच्या जवळची मदत · अचूकता ',
    dy_gps_meters: ' मी.',
    dy_near_all: '१ किमी — सर्व मदत',
    dy_my_location: 'माझे स्थान',
    dy_back_route: 'मार्गावर परत',
    dy_all_route: 'सर्व मार्ग',
    dy_gps_disabled: 'या फोनवर स्थान सुविधा उपलब्ध नाही',
    dy_gps_off_title: 'स्थान (Location) बंद आहे',
    dy_gps_off_desc: 'जवळची मदत दाखवण्यासाठी स्थान सुरू करा',
    dy_gps_retry: 'पुन्हा प्रयत्न करा',
    dy_gps_close: 'बंद करा',
    dy_gps_ask: 'जवळची मदत दाखवण्यासाठी\nतुमचे स्थान (GPS) सुरू करा',
    dy_gps_ask_small: 'रुग्णवाहिका, डॉक्टर, पाणी — तुमच्या अंतरानुसार दिसतील',
    dy_gps_ask_btn: 'स्थान द्या',
    dy_gps_later: 'नंतर',
    dy_offline_ready: 'ऑफलाईन तयार',
    dy_offline_updating: 'ऑफलाईन अद्ययावत केले (Reload करा)',
    dy_offline_installing: 'ऑफलाईन वारी तयार',
    dy_offline_progress: 'नकाशा डाऊनलोड: ',
    dy_no_results: 'या फिल्टरमध्ये कोणतेही मदत केंद्र सापडले नाही.',
    dy_search_label: 'इथून सर्व सेवा',
    dy_each_nearest: 'प्रत्येक सेवेतील सर्वात जवळचे',
    dy_mukkam_ref: 'मुक्काम ',
    dy_within_dist: ' या अंतरात काही नाही — मोठे अंतर निवडा',
    dy_nearest_services: 'आसपासच्या सर्व सेवा — ',
    dy_radius_area: ' मी. परिसर',
    dy_full_route: 'संपूर्ण मार्ग',
    dy_dist_sort: 'अंतरानुसार क्रम',
    dy_live_broadcast: 'थेट प्रक्षेपण',
    dy_contacts_main: 'मुख्य संपर्क',
    dy_contacts_medical: 'वैद्यकीय',
    dy_contacts_doc: 'डॉक्टर / EMSO',
    dy_contacts_pilot: 'पायलट / वाहन',
    dy_video_label: 'व्हिडिओ पहा',
    dy_weather_loading: 'पाहत आहोत…',
    dy_weather_rain: 'पाऊस',
    dy_map_offline: 'नकाशा ऑफलाइन उपलब्ध नाही. मदत केंद्रांची यादी खाली उपलब्ध आहे.',
    dy_near: 'अगदी जवळ',
    dy_walking_time: 'चालत',
    dy_mins: 'मि.',
    dy_km: 'किमी',
    dy_gps_nearest: 'सर्वात जवळचे',
    dy_weather_clear: 'स्वच्छ',
    dy_weather_few: 'थोडे ढग',
    dy_weather_cloudy: 'ढगाळ',
    dy_weather_fog: 'धुके',
    dy_weather_drizzle: 'भुरभुर',
    dy_weather_cold_drizzle: 'थंड भुरभुर',
    dy_weather_cold_rain: 'थंड पाऊस',
    dy_weather_snow: 'बर्फ',
    dy_weather_heavy_rain: 'मुसळधार',
    dy_weather_snowfall: 'बर्फवृष्टी',
    dy_weather_storm: 'वादळी पाऊस',
    dy_call_btn: 'फोन करा'
  },
  en: {
    ...
    hero_title: 'Track the Palkhi Journey in Real Time.',
    hero_desc: 'Stay connected with the sacred Wari journey. View the live location, route updates, estimated arrival times, and important announcements throughout the pilgrimage.',
    hero_status_dot: 'Both Palkhis are currently active on the route. Live tracking is available.',
    tukaram_palkhi: 'Sant Tukaram Maharaj Palkhi',
    dnyaneshwar_palkhi: 'Sant Dnyaneshwar Maharaj Palkhi',
    current_stop: 'Current Stop',
    last_updated: 'Last Updated',
    tracking_closed: 'Live Tracking Closed',
    btn_about_us: 'About Us ↗',
    live_tracking_badge: 'Live Tracking',
    map_title: 'Pilgrim Resource Locator Map',
    tab_both: 'Both',
    tab_dnyaneshwar: 'Sant Dnyaneshwar Maharaj',
    tab_tukaram: 'Sant Tukaram Maharaj',
    search_placeholder: 'Search location, doctor, vehicle number...',
    chip_100m: '100 m',
    chip_200m: '200 m',
    chip_300m: '300 m',
    chip_1km: '1 km',
    chip_5km: '5 km',
    chip_all: 'All',
    mukkam_title: 'Palkhi Halt Schedule',
    emergency_dials_title: 'Emergency Dials',
    dial_ambulance: 'Ambulance',
    dial_emergency: 'Emergency',
    helpline_other: 'Other Health Helplines',
    helpline_advisory: 'Health Advice / Complaint / Blood / Mental Health',
    helpline_jssy: 'Janani Shishu Suraksha Karyakram',
    helpline_mjp: 'Mahatma Jyotiba Phule Jan Arogya Yojana',
    helpline_disaster: 'Disaster Management',
    helpline_district: 'District Officers',
    helpline_state: 'State / Divisional / Municipal Officers',
    helpline_police: 'Police Directory',
    clips_title: 'Health Messages · Videos / Audios',
    clips_all: 'View All Videos / Audios',
    mapcard_title: 'Help Map',
    mapcard_subtitle: 'Both Palkhis',
    btn_1km_all: '1 km — All Help',
    btn_my_location: 'My Location',
    btn_back_to_route: 'Back to Route',
    dest_label: "Today's Destination",
    dest_val: 'Loni Kalbhor & Saswad',
    eta_label: 'Estimated Arrival Time',
    eta_val: '5:45 PM',
    sub_amb: 'Ambulance Type:',
    sub_doc: 'Clinic Type:',
    sub_water: 'Water Type:',
    sub_halt: 'Halt Type:',
    leg_all: 'All',
    leg_ambulance: 'Ambulance',
    leg_doc: 'Doctor/Clinic',
    leg_water: 'Water',
    leg_toilet: 'Toilets',
    leg_police: 'Police',
    leg_charanseva: 'Charanseva',
    leg_hirkani: 'Hirkani Cabin',
    leg_halt: 'Halt',
    leg_loc: 'My Location',
    stat_devotees: 'Devotees',
    stat_journey: 'KM Journey',
    stat_updates: 'Live Updates',
    stat_halts: 'Halt Points',
    impact_badge: 'Impact',
    impact_title: 'Connecting Millions Through the Sacred Wari',
    impact_desc: 'Experience the Wari like never before with live GPS tracking, route updates, halt locations, and estimated arrival times. Our platform helps devotees, volunteers, and visitors stay informed throughout the sacred journey.',
    impact_today_journey: "Today's Journey",
    impact_next_halt: 'Next Halt ETA',
    summary_badge: 'Summary',
    summary_title: 'Wari Management & Planning Review',
    summary_desc: 'The administration has adopted a comprehensive, technology-driven and citizen-centric approach for the Ashadhi Wari 2026, integrating 24x7 smart surveillance, AI-powered traffic management, advanced public safety systems and large-scale operational deployment to ensure a secure and seamless pilgrimage.',
    faq_badge: 'Facts',
    faq_title: 'Wari 2026: Resource & Arrangements',
    faq_q1: 'Is this page active for the entire journey from Dehu and Alandi to Pandharpur?',
    faq_a1: 'Yes, this platform remains active throughout the entire pilgrimage to provide live coordinates and location-based assistance to devotees.',
    faq_q2: 'How many volunteers and coordinators are on-ground for the Wari arrangements?',
    faq_a2: 'Thousands of security guards, medical volunteers, and administration coordinators are deployed across the route to monitor movement and resolve bottlenecks.',
    faq_q3: 'How are the current locations and service distances calculated?',
    faq_a3: 'Locations are tracked via active GPS units installed on the administrative vehicles accompanying the Palkhis, and synchronized with on-ground volunteer networks.',
    faq_metric_palkhis: 'Sacred Palkhis',
    faq_metric_route: 'Route / Day',
    faq_metric_coord: 'On-Ground Coord.',
    btn_route_map: 'Route Map ↗',
    footer_overlay_title: 'Stay Updated Throughout the Wari',
    footer_col_palkhi: 'Palkhi',
    footer_col_emergency: 'Emergency Contacts',
    footer_scroll_top: 'Scroll to Top ↗',
    nav_driver_reg: 'Driver Reg',
    nav_portal_login: 'Portal Login',
    nav_landing: 'Home',
    
    // Dynamic labels
    dy_amb_service: 'Ambulance Service',
    dy_hosp_service: 'Hospital Service',
    dy_doc_service: 'Doctor / Health Service',
    dy_water_service: 'Water',
    dy_help_center: 'Help Center',
    dy_veh_no: 'Vehicle Number:',
    dy_service: 'Service:',
    dy_place: 'Location:',
    dy_base: 'Base Location:',
    dy_toilet: 'Total Toilets:',
    dy_date: 'Date:',
    dy_phase: 'Phase:',
    dy_direction: 'Direction',
    dy_share: 'Share',
    dy_nearby_help: 'All Help Near This Halt (1 km)',
    dy_you_are_here: 'You are here',
    dy_gps_not_active: 'GPS Not Active',
    dy_gps_getting: 'Getting GPS location...',
    dy_gps_denied: 'Location permission denied. Enable in Settings.',
    dy_gps_timeout: 'GPS timeout. Try again.',
    dy_gps_error: 'GPS error. Try again.',
    dy_gps_acc: 'Help near you · Accuracy ',
    dy_gps_meters: ' m',
    dy_near_all: '1 km — All Help',
    dy_my_location: 'My Location',
    dy_back_route: 'Back to Route',
    dy_all_route: 'All Routes',
    dy_gps_disabled: 'Location service is not available on this phone',
    dy_gps_off_title: 'Location is Turned Off',
    dy_gps_off_desc: 'Enable location services to find help near you',
    dy_gps_retry: 'Try Again',
    dy_gps_close: 'Close',
    dy_gps_ask: 'Enable location (GPS) to find resources near you',
    dy_gps_ask_small: 'Ambulances, doctors, water will be sorted by distance',
    dy_gps_ask_btn: 'Allow GPS',
    dy_gps_later: 'Later',
    dy_offline_ready: 'Offline Ready',
    dy_offline_updating: 'Offline Updated (Reload required)',
    dy_offline_installing: 'Preparing Offline Wari...',
    dy_offline_progress: 'Map download: ',
    dy_no_results: 'No help centers found in this filter.',
    dy_search_label: 'All Services From Here',
    dy_each_nearest: 'Nearest facility for each service',
    dy_mukkam_ref: 'Halt ',
    dy_within_dist: ' No resources in this range — select a larger radius',
    dy_nearest_services: 'All nearby services — ',
    dy_radius_area: ' m radius',
    dy_full_route: 'Entire route',
    dy_dist_sort: 'Sorted by distance',
    dy_live_broadcast: 'Live Broadcast',
    dy_contacts_main: 'Primary Contact',
    dy_contacts_medical: 'Medical',
    dy_contacts_doc: 'Doctor / EMSO',
    dy_contacts_pilot: 'Pilot / Driver',
    dy_video_label: 'Watch Video',
    dy_weather_loading: 'Loading...',
    dy_weather_rain: 'Rain',
    dy_map_offline: 'Map not available offline. Help centers list is available below.',
    dy_near: 'Very Close',
    dy_walking_time: 'Walk',
    dy_mins: 'min',
    dy_km: 'km',
    dy_gps_nearest: 'Nearest',
    dy_weather_clear: 'Clear',
    dy_weather_few: 'Few Clouds',
    dy_weather_cloudy: 'Cloudy',
    dy_weather_fog: 'Fog',
    dy_weather_drizzle: 'Drizzle',
    dy_weather_cold_drizzle: 'Cold Drizzle',
    dy_weather_cold_rain: 'Cold Rain',
    dy_weather_snow: 'Snow',
    dy_weather_heavy_rain: 'Heavy Rain',
    dy_weather_snowfall: 'Snowfall',
    dy_weather_storm: 'Thunderstorm',
    dy_call_btn: 'Call'
  }
};
...
window.switchLanguage = function(lang) {
  localStorage.setItem('wari_lang', lang);
  ...
  document.querySelectorAll('[data-i18n]').forEach(el => {
    ...
    if (T[lang] && T[lang][key]) {
      ...
      if (svg) {
        el.innerHTML = T[lang][key] + ' ' + svg.outerHTML;
      } else {
  ...
  // Re-run dynamic rendering functions in app.js
  if (window.refresh) {
    window.refresh();
  }
  
  // Re-run dynamic directory render functions
  if (window.renderOfficials) {
    window.renderOfficials();
  }
  if (window.renderDignitaries) {
    window.renderDignitaries();
  }
};
...
function $(id){return document.getElementById(id)}function tick(){var c=$('clock');if(c)c.textContent=new Date().toLocaleTimeString('mr-IN',{hour:'numeric',minute:'2-digit',hour12:true})}tick();setInterval(tick,3e4);
...
function initMap(){if(map)return;if(!window.L){$('map').innerHTML='<div style="padding:18px;font-weight:900">नकाशा ऑफलाइन उपलब्ध नाही. मदत केंद्रांची यादी खाली उपलब्ध आहे.</div>';return}map=L.map('map',{zoomControl:false,minZoom:9,maxBounds:[[17.3,73.4],[19.1,75.7]],maxBoundsViscosity:1}).setView([18.41936,74.02765],10);L.control.zoom({position:'bottomleft'}).addTo(map);L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png',{maxZoom:18,maxNativeZoom:14,attribution:'&copy; OpenStreetMap contributors',errorTileUrl:'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNk+M9QDwADhgGAWjR9awAAAABJRU5ErkJggg=='}).addTo(map);map.on('popupopen',()=>setTimeout(initLive,60));map.on('zoomend',()=>{if((map.getZoom()>=SC_MIN_ZOOM)!==scVis)draw(drawnPts)})}
function hav(a,b,c,d){let R=6371000,r=x=>x*Math.PI/180,dl=r(c-a),dn=r(d-b),q=Math.sin(dl/2)**2+Math.cos(r(a))*Math.cos(r(c))*Math.sin(dn/2)**2;return 2*R*Math.atan2(Math.sqrt(q),Math.sqrt(1-q))}function dev(x){return String(x).replace(/[0-9]/g,d=>'०१२३४५६७८९'[d])}function fd(m){return m==null?'—':m<80?t('dy_near'):m<6000?t('dy_walking_time')+' '+dev(Math.max(1,Math.round(m/75)))+' '+t('dy_mins'):dev((m/1000).toFixed(1))+' '+t('dy_km')}function refLoc(){return userLocation||mukkamRef}function dist(p){let r=refLoc();return r?hav(r[0],r[1],p.lat,p.lng):null}function dir(p){return`https://www.google.com/maps/dir/?api=1&destination=${p.lat},${p.lng}`}
...
function popContactRows(p){let rows=[[t('dy_contacts_main'),p.call],[t('dy_contacts_medical'),p.mo||p.doctor],[t('dy_contacts_doc'),p.mo?p.doctor:''],[t('dy_contacts_pilot'),p.pilot]];return rows.map(([title,val])=>{let links=splitContacts(val).filter(c=>c.phone).slice(0,5).map(c=>`<a class="pcall" href="tel:${phoneHref(c.phone)}">${W.esc(c.name)} <b>${W.esc(c.phone)}</b></a>`).join('');return links?`<div class="pcontacts"><div class="pctitle">${W.esc(title)}</div><div class="pcalls">${links}</div></div>`:''}).join('')}
function popup(p){let c=firstPhone(p.call,p.mo,p.doctor,p.pilot),chips=W.services(p).map(x=>`<span class="pchip">${W.esc(x)}</span>`).join(''),cls=W.cls(p);let d=[];if(p.place&&!(p.label||'').includes(p.place))d.push(t('dy_place')+' '+W.esc(p.place));if(p.vehicle)d.push(t('dy_veh_no')+' '+W.esc(p.vehicle));if(p.base)d.push(t('dy_base')+' '+W.esc(p.base));if(p.date)d.push(t('dy_date')+' '+W.esc(p.date)+(p.day?' · '+W.esc(p.day):''));let contacts=popContactRows(p);let hk=(W.hasHirkani(p)&&p.photo)?`<img class="pop-thumb" src="${W.escAttr(W.safeAsset(p.photo,HIRKANI_PHOTO))}" loading="lazy" onerror="this.remove()"/>`:'';return`<div class="pop pop-${cls}"><div class="phead"><span class="picon">${W.icon(p)}</span><div><div class="ptitle">${W.esc(p.label)}</div><div class="psub">${W.esc(W.NAMES[p.palkhi]||p.palkhi)}</div></div></div><div class="pbody"><div class="pchips">${chips}</div>${p.live?liveBlock(p.live):''}${hk}${d.length?`<div class="pdet">${d.join('<br>')}</div>`:''}${contacts}<div class="pact">${W.isHalt(p)?`<button class="pbtn call" style="border:0;cursor:pointer" onclick="nearbyAt(${p._idx})">जवळची मदत</button>`:''}${c?`<a class="pbtn call" href="tel:${phoneHref(c)}">t('dy_call_btn')</a>`:''}<a class="pbtn dirbtn" target="_blank" rel="noopener noreferrer" href="${dir(p)}">${t("dy_direction")}</a></div></div></div>`}
...
function charansevaCard(p){let route=W.NAMES[p.palkhi]||p.palkhi,when=[p.date,p.day].filter(Boolean).join(' · ');return`<article class="card charanseva charanseva-card"><span class="dist">${fd(p.dist)}</span><div class="cs-head"><img src="${W.escAttr(CHARANSEVA_PHOTO)}" alt="चरणसेवा" loading="lazy"><div><div class="cs-kicker">भक्ती विठोबाची · सेवा वारकऱ्यांची</div><div class="formatted-title">${W.esc(p.label)}</div></div></div><div class="badges">${p._fb?'<span class="badge ok">${t("dy_gps_nearest")}</span>':''}<span class="badge">${W.esc(route)}</span></div><div class="formatted-service cs-service"><b>${t("dy_service")}</b> भाविकांची चरणसेवा</div>${p.place?`<div class="formatted-field"><b>${t("dy_place")}</b> ${W.esc(p.place)}</div>`:''}${when?`<div class="formatted-field"><b>${t("dy_date")}</b> ${W.esc(when)}</div>`:''}${p.phase?`<div class="formatted-field"><b>पालखी:</b> ${W.esc(p.phase.replace(' चरणसेवा',''))}</div>`:''}<div class="act"><a class="dir" target="_blank" rel="noopener noreferrer" href="${dir(p)}">${t("dy_direction")}</a><button class="share" onclick="openShare(${p._idx})">📤 ${t("dy_share")}</button></div></article>`}
function card(p){if(W.isCharanseva(p))return charansevaCard(p);let c=W.tel(p.call),mems=W.isHBT(p)?'हिंदुहृदयसम्राट बाळासाहेब ठाकरे आपला दवाखाना':W.isPolice(p)?'पोलीस स्टेशन':p.mems,service=[W.NAMES[p.palkhi],mems?`(${mems})`:'' ].filter(Boolean).join(' – ');let extra=c&&W.hasAmb(p)?[{name:'रुग्णवाहिका संपर्क',phone:c,cls:'ambulance-main'}]:[];return`<article class="card ${W.cls(p)}"><span class="dist">${fd(p.dist)}</span><div class="formatted-title">${W.esc(W.hasHirkani(p)||W.isToilet(p)||W.isPolice(p)||W.isHalt(p)?p.label:(t=>{let b=p.label.replace(/\b[A-Z]{2}\s*\d{1,2}\s*[A-Z]{1,3}\s*\d{3,4}\b/ig,'').replace(/\s*[|–-]\s*$/,'').trim();return b.startsWith(t)||/^(प्रा\.? ?आ\.? ?केंद्र|ग्रामीण रुग्णालय|उपजिल्हा रुग्णालय|महानगरपालिका रुग्णालय|खाजगी रुग्णालय|हिंदुहृदयसम्राट बाळासाहेब ठाकरे आपला दवाखाना|HBT|रुग्णालय|दवाखाना)/.test(b)?b:t+' – '+b})(W.hasAmb(p)?t('dy_amb_service'):W.hasHospital(p)?t('dy_hosp_service'):W.hasDoc(p)?t('dy_doc_service'):W.hasWater(p)?t('dy_water_service'):t('dy_help_center')))}</div><div class="badges">${p._fb?'<span class="badge ok">${t("dy_gps_nearest")}</span>':''}<span class="badge">${W.esc(W.NAMES[p.palkhi])}</span></div>${p.vehicle?`<div class="formatted-vehicle"><b>${t("dy_veh_no")}</b> ${W.esc(p.vehicle)}</div>`:''}<div class="formatted-service"><b>${t("dy_service")}</b> ${W.esc(service)}</div>${p.place?`<div class="formatted-field"><b>${t("dy_place")}</b> ${W.esc(p.place)}</div>`:''}${p.base?`<div class="formatted-field"><b>${t("dy_base")}</b> ${W.esc(p.base)}</div>`:''}${p.toilet?`<div class="formatted-field"><b>${t("dy_toilet")}</b> ${W.esc(p.toilet)}${p.sites?` <b>· ठिकाणे:</b> ${W.esc(p.sites)}`:''}</div>`:''}${p.mo?contactSection('वैद्यकीय अधिकारी (MO)',p.mo):''}${contactSection(W.isPolice(p)?'पोलीस अधिकारी':W.hasHirkani(p)?'हिरकणी कक्ष संपर्क':t('dy_contacts_doc'),p.doctor)}${contactSection('पायलट / EA / रुग्णवाहिका संपर्क',p.pilot,extra)}${p.date?`<div class="formatted-field"><b>${t("dy_date")}</b> ${W.esc(p.date)}${p.day?` · ${W.esc(p.day)}`:''}</div>`:''}${p.phase?`<div class="formatted-field"><b>${t("dy_phase")}</b> ${W.esc(p.phase)}</div>`:''}${p.live?liveBlock(p.live):''}${p.photo?hirkaniMedia(p):''}<div class="act">${W.isHalt(p)?`<button style="grid-column:1/-1;border:0;border-radius:13px;padding:10px 6px;font-weight:950;background:#f27405;color:#fff" onclick="nearbyAt(${p._idx})">${t("dy_nearby_help")}</button>`:''}<a class="dir" target="_blank" rel="noopener noreferrer" href="${dir(p)}">${t("dy_direction")}</a><button class="share" onclick="openShare(${p._idx})">📤 ${t("dy_share")}</button></div></article>`}
...
var NEAR_CATS=[
  ...
  {s:t('dy_water_service'),ic:'💧',c:'#2f8fcf',bg:'#e9f1ff',m:p=>W.hasWater(p)},
...
function renderNearSummary(){let el=$('nearSummary');if(!el)return;
  ...
  let where=userLocation?'तुमचे स्थान':(t('dy_mukkam_ref')+(mukkamName||''));
  let list=[],rows='';
...
function refresh(){updateSubChips();let pts=visible();$('count').textContent=pts.length;$('gps').textContent=(refLoc()&&rad<99999999&&!pts.length)?t('dy_within_dist'):userLocation?(cat==='near'?(t('dy_nearest_services')+(rad<99999999?dev(rad)+t('dy_radius_area'):t('dy_full_route'))):t('dy_dist_sort')):mukkamRef?(t('dy_mukkam_ref')+mukkamName+' — '+(rad<99999999?dev(rad)+t('dy_radius_area'):t('dy_full_route'))):'GPS सुरू नाही';drawRoute();draw(pts);render(pts);counts();renderNearSummary();if(map)setTimeout(()=>map.invalidateSize(true),100)}
...
refresh();$('gps').textContent=t('dy_mukkam_ref')+m.n+' ('+(m.d||'तारीख निश्चित नाही')+') — '+dev(rad)+t('dy_radius_area');}
...
window.WARI_MUKKAMS.forEach((m,i)=>{let ic=m.pal==='tukaram'?'orange':'blue';
h+=`<button class="mchip" data-mukkam="${i}" onclick="chooseMukkam(${i})"><span class="mdot mdot-${ic}"></span> ${m.d?m.d+' · ':''}${m.n}</button>`});
el.innerHTML=h})();
...
function wxDesc(c){if(c===0)return['☀️',t('dy_weather_clear')];if(c<=2)return['🌤️',t('dy_weather_few')];if(c===3)return['☁️',t('dy_weather_cloudy')];if(c===45||c===48)return['🌫️',t('dy_weather_fog')];if(c>=51&&c<=57)return['🌦️','रिमझिम'];if(c>=61&&c<=67)return['🌧️',t('dy_weather_rain')];if(c>=71&&c<=77)return['🌨️',t('dy_weather_snow')];if(c>=80&&c<=82)return['🌧️','सरी'];if(c>=95)return['⛈️','गडगडाटी पाऊस'];return['🌡️','—']}
